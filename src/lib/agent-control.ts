...
export function getAgentControlSnapshot(): AgentControlSnapshot {
  ...
  pushPriority(
    ...
    focusSnapshot.overdueCount > 0
      ? {
          ...
          action: "Разобрать хвосты: что удалить, что перенести и что сделать сегодня первым.",
          href: "/tasks",
  ...
  pushPriority(
    ...
    attentionProject
      ? {
          ...
          action: "Развернуть текущий next step в 2–3 конкретных действия и выбрать одно главное на сегодня.",
  ...
  pushPriority(
    ...
    healthLevel !== "good"
      ? {
          ...
          action: "Зафиксировать минимальный health floor на день: сон, растяжка, бег/прогулка и нужный follow-up по анализам.",
          href: "/medical",
          level: healthLevel,
  ...
  pushPriority(
    ...
    familyLevel !== "good" && upcoming.studio > 0
      ? {
          ...
          action: "Накидать семейные буферы и логистику на 3–7 дней вперёд, пока неделя ещё управляемая.",
          href: "/calendar",
          level: familyLevel,
  ...
  pushPriority(
    ...
    reflectionLevel !== "good"
      ? {
          ...
          action: "Собрать короткий review: что происходит, что буксует, что важно и какой фокус нужно обновить.",
          href: "/journal",
          level: reflectionLevel,
  ...
  pushPriority(
    ...
    recoveryLevel !== "good"
      ? {
          ...
          action: "Создать хотя бы одно невыбиваемое окно восстановления и увязать его с ритмом недели.",
          href: "/routines",
          level: recoveryLevel,
  ...
  if (priorityCandidates.length === 0) {
    priorityCandidates.push({
      ...
      action: "Продолжать фиксировать, что происходит, без раздувания системы и ручного учёта.",
      href: "/",
      level: "good",
      weight: 1,
    });
